/**
 * «Мои курсы» преподавателя.
 *
 * В отличие от каталога, здесь показываются ВСЕ статусы — черновики и архив тоже.
 * Это рабочий список автора, а не витрина: он должен видеть то, что ещё не
 * опубликовал.
 */
