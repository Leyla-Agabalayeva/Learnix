 ...
 * Создание курса.
 *
 * Курс создаётся в статусе Draft — это решение сервера, не фронтенда
 * (CourseService.CreateAsync). Поэтому после создания пользователь попадает
 * не в каталог, а в конструктор: пустой курс всё равно нельзя опубликовать,
 * пока в нём нет содержимого.
 */
