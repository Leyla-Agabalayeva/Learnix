/**
 * Студенты курса (раздел 27 ТЗ).
 *
 * Список приходит из /api/courses/{id}/students — эндпоинт проверяет владение
 * курсом, поэтому подставить в адрес чужой courseId и увидеть чужих студентов
 * не выйдет: сервер ответит 403.
 */
